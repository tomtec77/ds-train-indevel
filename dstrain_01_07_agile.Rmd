...
is uncertain! At the beginning you don't know what the data looks like, if
there are any major issues affecting the data, and you may discover unexpected
things along the way. Remember that data science is about discovery! This
uncertainty greatly affects the definition and estimation of user stories.
